...
public class TestHttpServletDoHeadInvalidWrite1023ValidWrite511 extends HttpServletDoHeadBaseTest {
                        ...
                        for (ResetType rt : ResetType.values()) {
                            for (Boolean f : booleans) {
                                parameterSets.add(new Object[] {
                                        base[0], base[1],
                                        l, buf, w, Integer.valueOf(1023), rt, Integer.valueOf(511), f });
                            }
                        }
                    }
                }
