...
public class TestHttpServletDoHeadInvalidWrite512ValidWrite1024 extends HttpServletDoHeadBaseTest {
                        ...
                        for (ResetType rt : ResetType.values()) {
                            for (Boolean f : booleans) {
                                parameterSets.add(new Object[] {
                                        base[0], base[1],
                                        l, buf, w, Integer.valueOf(512), rt, Integer.valueOf(1024), f });
                            }
                        }
                    }
                }
