...
public class TestHttpServletDoHeadInvalidWrite1025ValidWrite513 extends HttpServletDoHeadBaseTest {
                        ...
                        for (ResetType rt : ResetType.values()) {
                            for (Boolean f : booleans) {
                                parameterSets.add(new Object[] {
                                        base[0], base[1],
                                        l, buf, w, Integer.valueOf(1025), rt, Integer.valueOf(513), f });
                            }
                        }
                    }
                }
