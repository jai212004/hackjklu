...
public interface ChannelMessage extends Serializable, Cloneable {
    ...
    /**
     * Get the address that this message originated from. Almost always <code>Channel.getLocalMember(boolean)</code>.
     * This would be set to a different address if the message was being relayed from a host other than the one that
     * originally sent it.
     *
