...
/**
 * The MembershipListener interface is used as a callback to the membership service. It has two methods that will notify
 * the listener when a member has joined the group and when a member has disappeared (crashed)
 */
